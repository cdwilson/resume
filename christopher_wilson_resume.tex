...
\cventry{2010 -- 2018}{Electronics Design Engineer}{\httpslink[Cisco Systems]{www.cisco.com}}{San Jose, CA}{}
{
  ...
  \begin{itemize}
    ...
    \item Lead electronics designer for IEEE 802.15.4g hardware reference designs used by Cisco DevNet partners to develop 3rd-party \httpslink[Cisco Resilient Mesh End Point (CRME)]{developer.cisco.com/docs/ipv6-mesh/\#!sdk/resilient-mesh-new} devices.
