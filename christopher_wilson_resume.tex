...
\cventry{2022 -- Present}{Principal Engineer}{\httpslink[Common Ground Electronics]{cgnd.dev}}{Castro Valley, CA}{}
{
  \textit{Boutique embedded systems engineering services firm}
}
...
\cventry{2010 -- 2018}{Electronics Design Engineer}{\httpslink[Cisco Systems]{www.cisco.com}}{San Jose, CA}{}
{
  ...
  \begin{itemize}
    \item Co-designed Cisco's first industrial IOx ``fog'' \httpslink[compute module]{www.cisco.com/c/en/us/products/collateral/routers/1000-series-connected-grid-routers/datasheet-c78-739683.html}, enabling customers to run custom IoT applications on Cisco 1000 Series Connected Grid Routers.
    \item Lead electronics design engineer for IEEE 802.15.4g hardware reference designs used by Cisco DevNet partners to develop 3rd-party \httpslink[Cisco Resilient Mesh End Point (CRME)]{developer.cisco.com/docs/ipv6-mesh/\#!sdk/resilient-mesh-new} devices.
...
\cventry{2007 -- 2010}{Electronics Design Engineer}{\httpslink[Arch Rock (acquired by Cisco Systems)]{www.cisco.com/c/en/us/about/corporate-strategy-office/acquisitions/arch-rock.html}}{San Francisco, CA}{}
{
  ...
  \begin{itemize}
    ...
    \item Designed and launched 802.15.4 2.4GHz \httpslink[PhyNet™]{www.si.edu/object/arch-rock-phynet-wireless-sensor-network\%3Anmah_1822657} wireless sensors and router network interface cards for enterprise-scale wireless sensor networks.
  \end{itemize}
}
\cventry{2006}{Undergraduate Researcher}{\httpslink[Berkeley Wireless Research Center]{bwrc.eecs.berkeley.edu}}{Berkeley, CA}{}
{
...
\cventry{2004}{Interim Engineering Intern}{\httpslink[Qualcomm]{www.qualcomm.com}}{San Diego, CA}{}
{
...
\cventry{2009 -- 2015}{Owner}{\httpslink[Flying Camp Design]{flyingcamp.design}}{Castro Valley, CA}{}
{
...
\cventry{2010 -- 2014}{Partner}{\httpslink[Moteware]{moteware.com}}{Berkeley, CA}{}
{
