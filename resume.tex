...
%
% This work consists of the files resume.tex
...
\address{1243 Roslyn Ln}{La Jolla, CA 92037}
...
\cventry{2010 -- Present}{Hardware Engineer}{Cisco Systems}{San Jose, CA}{}
{
...
\cventry{2007 -- 2010}{Hardware Engineer}{Arch Rock}{San Francisco, CA}{}
{
  \begin{itemize}
...
\cventry{2010 -- Present}{Proprietor}{Flying Camp Design}{La Jolla, CA}{}
{
  \textit{Indie hardware and software design}
  \begin{itemize}
    \item Designed open-hardware boot-strap loader (BSL) programmer for TI MSP430 MCUs.  Over 100 programmers sold internationally to date.
    \item Developed open-source, cross-platform BSL GUI utility in Python
  \end{itemize}
}
\cventry{2010 -- 2014}{Partner}{Moteware}{Berkeley, CA}{}
{
  \textit{Open-hardware disseminator for the academic research community}
  \begin{itemize}
    \item Founded with a group of current and former graduate students at UC Berkeley
    \item Managed sales, support, and IT for Moteware
  \end{itemize}
}

\section{Education}
\cventry{2003 -- 2007}{B.S. Electrical Engineering and Computer Science}{University of California Berkeley}{Berkeley, CA}{}{Awards: Edward Frank Kraft Scholarship\newline{}Activities and Societies: Alpha Gamma Omega, FoCUS, IEEE}

\section{Skills \& Expertise}
\cvitem{Lab}{PCA bring-up, electronic test equipment, hand rework, lab safety}
\cvitem{EDA}{Cadence Concept and Allegro, OrCAD Capture, Cadsoft EAGLE}
\cvitem{PLM}{Cisco Agile, Arena Solutions}
\cvitem{Advanced}{Git, Python}
\cvitem{Basic}{make, C, nesC, Bash, Ruby, Tcl/Tk, \LaTeX, Bazaar, SVN, CVS}
...
\cvitem{Board sports}{Surfing, skateboarding, snowboarding, etc.}
